...
## 📅 Day 2: 21/05/2024 (Tuesday)
      ...
      - 🎓 Conclusion 
## 📅 Day 3: 22/05/2024 (Wednesday)
      - 🔄 MySQL Database Administration
      - 📝 History Of SQL
      - 📜 Relational Databases
      - 🏁 Download & Setup
## 📅 Day 4: 23/05/2024 (Thursday)
      - 🔍 Creating Databases
      - 📸 Schema and Tables Management
      - ⚔️ Common MySQL Data Types
      - 🛠️ Data Manipulation
...
## Git and GitHub Basics:
- Git diff
    - The git diff command shows the differences between two commits. It compares the changes made in one commit with those in another.
...
- Command Examples:
    ...
    - Compare Staging Area with Repository: git diff --staged
    - Compare Branches: git diff <branch-one> <branch-two>
    - Compare Specific Commits: git diff <commit-one> <commit-two>
- Git Stash
...
- Commands:
    ...
    - Create annotated tag: git tag -a <tag-name> -m "Release 1.0"
- Rebase in Git
    - Rebase moves a branch to a new starting point, replaying the commits.

- Commands:
    -Rebase branch onto main: git rebase main
## 📅 Day 2: 21/05/2024 - Tuesday
## What is GitHub?
...
- MySQL Download & Setup

    - Download MySQL Workbench.
    - Run SQL script to create schemas.
## 📅 Day 4: 23/05/2024 - Thursday
## Creating the Databases

- Run SQL script in MySQL Workbench.
- Confirm successful creation of schemas.
- Creating, Altering & Deleting Schemas and Tables

    - Create schemas using SQL statements or UI tools.
...
- Database Normalization
    ...
    - Minimize redundancy and preserve data integrity.
    - Benefits: Efficient storage, reduced errors.
